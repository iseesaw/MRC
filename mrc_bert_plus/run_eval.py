...
def calc_f1_score(answers, prediction):
    ...
    for ans in answers:
        ...
        if lcs_len == 0:
            print("".join(ans_segs), "".join(prediction_segs))
            f1_scores.append(0)
            continue
...
if __name__ == '__main__':
    ground_truth_file   = json.load(open('cmrc/cmrc2018_dev.json', 'r', encoding="utf-8"))
    prediction_file     = json.load(open('output/predictions.json', 'r', encoding="utf-8"))
